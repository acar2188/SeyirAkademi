...
namespace SeyirAkademi_v1._1.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new UserDetail {UserAd=Input.UserAd, UserSoyad = Input.UserSoyad ,  UserName = Input.Email, Email = Input.Email };
